...
/// The embedded sealing secret's environment variable name, for callers that
/// want to check it was set explicitly (a release build) versus generated (a dev
/// build). Not read by this module directly; documented here alongside the
/// secret it names.
pub const SEAL_SECRET_ENV: &str = "BASTION_SEAL_SECRET";
